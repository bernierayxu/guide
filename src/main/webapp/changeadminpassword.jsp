...
function submit(){
			...
			function success(data, textStatus, jqXHR) {
				if(data == "1"){
					alert("Admin password has been changed successfully!");
					window.location.replace("http://gci4-lltravel.rhcloud.com/adminlogin.jsp");
				}
				else if(data == "0"){
...
<table>
  <thead>
    <tr>
      <th colspan="3">Change Administrator Password</th>
    </tr>
  </thead>
  <tbody>
  	<tr>
